...
% MSC8001/MSC8002
% Author: John Worrall
% Description:Given input data, design ANFIS, Ensemble ANFIS, SOM/ANFIS
% and compare results
% Requirments:Indexs.xlsx (Data Input)
%----------------------------
...
clearvars -except ModelRun MemFun A A_Final pTrain pTest pValid TrainInd ValidInd TestInd MaxAordOt MinAordOt TrainInputs TrainTargets ValidInputs ValidTargets TestInputs TestTargets
...
%   Use SOM to seperated training and validation set
    ...
    NInputSOM = B_Final(:,[2 3 4 5 6 8]); %SOM
    ...
    TestInputs=NInputSOM(TestInd,:);
    TestTargets=NOutputSOM(TestInd,:); 
...
%---------------------------------------------------------------   
elseif ModelRun == 10   % ensemble plot 
%--------------------------------------------------------------    
    ...
    Sim=xlsread('ResultsRun.xlsx','Ensemble100');
    test = Sim(:, 2);
    Sim(:,1)=[];
    Sim5 = Sim(:,1:5)
    Sim10 = Sim(:,1:10)
    ...
    AvSim = mean(Sim,2)';
    AvSim5 = mean(Sim5,2)';    
    AvSim10 = mean(Sim10,2)';
    AvSim50 = mean(Sim50,2)';
    ...
    Sim = Sim'
    pos = max(Sim);
    %pos = quantile(Sim,0.25)
    pos1= abs(AvSim-pos)

    neg = min(Sim);
    %neg= quantile(Sim,0.75)
    neg1= abs(AvSim-neg)    

    
    titleN = "Ensemble 100 forecast";
     figure(1)
     %boxplot(Sim.','symbol','','plotstyle', 'compact','whisker',1.5,'BoxStyle','outline','Colors',[0.8 0.8 0.8],'Notch','off','MedianStyle','line');
     %boxplot(Sim.','symbol','','PlotStyle','traditional','BoxStyle','outline','Colors',[0 0 0],'Notch','off','MedianStyle','line');
     boxplot(Sim,'symbol','','PlotStyle','traditional','BoxStyle','outline','Colors',[0 0 0],'Notch','on','Whisker',20,'MedianStyle','line');  
     %errorbar(1:length(AvSim),AvSim,neg1,pos1,'Color',[0.8 0.8 0.8])%,neg,pos)
     title('AllOrds Index ensemble forecast');
     ylim([ylimMin-10 ylimMax+10])
    ...
    'MarkerFaceColor','red','Color',[0.8 0.8 0.8]);
    h2=plot(AvSim,...
    '-o','MarkerSize',3,...
    'MarkerEdgeColor',[0 0 0],...
    'MarkerFaceColor','green','Color',[0.8 0.8 0.8]);
    set(gca, 'XTickMode', 'auto', 'XTickLabelMode', 'auto')
    xlabel('Time - (days)');
    ylabel('Value of Index ');
    legend([h1 h2],'observed','forecasted','Location', 'northwest');
    hold off;

    figure(2) 
    subplot(4,1,1)  
    boxplot(Sim5.','symbol','','PlotStyle','traditional','BoxStyle','filled','Colors',[0.8 0.8 0.8],'Notch','on','Whisker',20,'MedianStyle','line');  
    hold on;
    plot(test,'-o','MarkerSize',3,'MarkerEdgeColor',[0 0 0],'MarkerFaceColor','red','Color',[0 0 0]);
    plot(AvSim5,'-o','MarkerSize',3,'MarkerEdgeColor',[0 0 0],'MarkerFaceColor','green','Color',[0 0 0]);
    set(gca, 'XTickMode', 'auto', 'XTickLabelMode', 'auto')  
    legend('observed','forecasted','Location', 'northwest');
    ylabel('Ensemble - 5','FontSize',9);
    subplot(4,1,2)
    boxplot(Sim10.','symbol','','PlotStyle','traditional','BoxStyle','filled','Colors',[0.8 0.8 0.8],'Notch','on','Whisker',20,'MedianStyle','line');  
    hold on;
    plot(test,'-o','MarkerSize',3,'MarkerEdgeColor',[0 0 0],'MarkerFaceColor','red','Color',[0 0 0]);
    plot(AvSim10,'-o','MarkerSize',3,'MarkerEdgeColor',[0 0 0],'MarkerFaceColor','green','Color',[0 0 0])
    set(gca, 'XTickMode', 'auto', 'XTickLabelMode', 'auto') 
    legend('observed','forecasted','Location', 'northwest');
    ylabel('Ensemble - 10','FontSize',9);
    subplot(4,1,3)
    boxplot(Sim50.','symbol','','PlotStyle','traditional','BoxStyle','filled','Colors',[0.8 0.8 0.8],'Notch','on','Whisker',20,'MedianStyle','line');  
    hold on;
    plot(test,'-o','MarkerSize',3,'MarkerEdgeColor',[0 0 0],'MarkerFaceColor','red','Color',[0 0 0]);
    plot(AvSim50,'-o','MarkerSize',3,'MarkerEdgeColor',[0 0 0],'MarkerFaceColor','green','Color',[0 0 0])
    set(gca, 'XTickMode', 'auto', 'XTickLabelMode', 'auto')   
    legend('observed','forecasted','Location', 'northwest');
    ylabel('Ensemble - 50','FontSize',9);
    subplot(4,1,4)
    %boxplot(Sim.','symbol','','PlotStyle','traditional','BoxStyle','outline','Colors',[0 0 0],'Notch','on','Whisker',20,'MedianStyle','line');
    boxplot(Sim,'symbol','','PlotStyle','traditional','BoxStyle','filled','Colors',[0.8 0.8 0.8],'Notch','on','Whisker',20,'MedianStyle','line');  
    hold on;
    plot(test,'-o','MarkerSize',3,'MarkerEdgeColor',[0 0 0],'MarkerFaceColor','red','Color',[0 0 0]);
    plot(AvSim,'-o','MarkerSize',3,'MarkerEdgeColor',[0 0 0],'MarkerFaceColor','green','Color',[0 0 0])
    set(gca, 'XTickMode', 'auto', 'XTickLabelMode', 'auto');  
    legend('observed','forecasted','Location', 'northwest');
    ylabel('Ensemble - 100','FontSize',9);
    hold off;
    xlabel('Time - (days)');
